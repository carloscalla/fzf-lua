...
M.select_harpoon = function(selected, opts)
  if not selected[1] then
    return
  end

  print("hola")
  -- get the first character from the selected line
  local harpoon_index = selected[1]:sub(7, 7)
  -- string.sub

  print("selected[1]", selected[1])
  print("harpoon_index", harpoon_index)
